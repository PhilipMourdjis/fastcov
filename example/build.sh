...
# Save for later
BASE_DIR=${PWD}
SOURCE_DIR=${BASE_DIR}/cmake_project/src
BUILD_DIR=${BASE_DIR}/cmake_project/build
...
${BASE_DIR}/fastcov.py --gcov gcov-9 --branch-coverage --exclude /usr/include test/ build/ ${BUILD_DIR}/ -o example.json
